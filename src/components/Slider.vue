    ...
    <div id="revolutionSlider" class="slider rev_slider manual" data-version="5.4.8">
      <ul>
        <li data-transition="fade">
          ...
          <h1
            class="tp-caption font-weight-bold text-color-light text-center"
            data-x="center"
            data-y="center"
          ...
          >Complete Solution For Your Education Needs</h1>

          <a
            class="tp-caption btn btn-primary text-1 font-weight-semibold custom-btn-style-1"
            href="#"
            data-x="center"
            data-y="center"
        ...
        <li data-transition="fade">
          <img
            src="img/demos/education/slides/slide-2.jpg"
            alt
            data-bgposition="center center"
            data-bgfit="cover"
            data-bgrepeat="no-repeat"
          ...
          <h1
            class="tp-caption font-weight-bold text-color-dark text-center"
            data-x="center"
            data-y="center"
            data-voffset="['10','10','10','10']"
            data-width="['770','770','770','350']"
            ...
            data-transform_out="opacity:0;s:500;"
            style="white-space: normal;"
          >Your Future Is Coming For You, Get Ready!</h1>
